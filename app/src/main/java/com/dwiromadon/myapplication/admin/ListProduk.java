...
public class ListProduk extends AppCompatActivity {
    ...
    Intent i;
    String produk, _id, namaPetshop, idUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit / Hapus Produk");
        ...
        newsList.clear();
        adapter = new AdapterProduk(ListProduk.this, newsList);
                ...
                Pop.on(ListProduk.this)
                        ...
                        .show(new Pop.View() { // assign value to view element
                            ...
                            public void prepare(View view) {
                                ...
                                txtJudul.setText("Edit / Hapus Produk");
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        try {
                                            ...
                                            array.put(new JSONObject()
                                                            .put("namaProduk", strNama)
                                                            .put("hargaProduk", strHarga));
                                            jsonObj1.put("produk", array);
                                            ubahProduk(jsonObj1, newsList.get(position).get_id());
                                ...
                                btnHapus.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        hapusProduk(newsList.get(position).get_id());
                                    }
                                });
    ...
    public void produk() {
        try {
            ...
            for (int i = 0; i < arrayProduk.length(); i++){
                ...
                String strNamaProduk = objProduk.getString("namaProduk");
                String strHargaProduk = objProduk.getString("hargaProduk");
    ...
    public void ubahProduk(JSONObject datas, String id){
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.PUT, BaseURL.updatePetDataProduk+ _id +"/" +id, datas,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if(status == false){
                                ...
                                Intent i = new Intent(ListProduk.this, DataPetshop.class);
                                i.putExtra("_id", _id);
    ...
    public void hapusProduk(String id){
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.DELETE, BaseURL.hapusPetDataProduk+ _id +"/" +id, null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        try {
